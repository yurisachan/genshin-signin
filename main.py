...
COOKIE = os.environ.get("GS_COOKIE")
PUSH_KEY = os.environ.get("SEND_KEY")
...
def get_ds(query: str = "", body: dict = None) -> str:
    ...
    # 核心修复点：将 body 转化为紧凑的 JSON 字符串参与哈希
